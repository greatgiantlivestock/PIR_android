...
public class MstUser {
	...
	public MstUser(int id_user, String nama, String username, String password, int id_departemen, int id_wilayah , int id_karyawan,
				   String hak_akses, String no_hp, int id_role){
	...
	// constructor
	public MstUser(String nama, String username, String password, int id_departemen, int id_wilayah, int id_karyawan, String hak_akses, String no_hp, int id_role){
		this.nama = nama;
		this.username = username;
		this.password = password;
		this.id_departemen = id_departemen;
