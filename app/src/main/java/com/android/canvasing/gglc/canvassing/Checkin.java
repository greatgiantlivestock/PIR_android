...
public class Checkin extends ActionBarActivity implements
	...
	private static final String LOG_TAG = Checkin.class
			.getSimpleName();
		...
		history.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				if(mulai.getText().toString().equals("") && sampai.getText().toString().equals("")){
					Toast.makeText(Checkin.this, "Kolom tangal masih kosong",Toast.LENGTH_LONG).show();
				}else{
