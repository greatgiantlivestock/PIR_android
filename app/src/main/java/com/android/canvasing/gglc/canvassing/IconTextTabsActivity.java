...
import com.android.canvasing.gglc.fragment.ThreeFragment;
import com.android.canvasing.gglc.fragment.TwoFragment;
...
public class IconTextTabsActivity extends AppCompatActivity implements NavigationDrawerCallbacks{
    ...
    private static final String LOG_TAG = IconTextTabsActivity.class.getSimpleName();
    ...
    */
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new TwoFragment(), "Unregister Customer");
