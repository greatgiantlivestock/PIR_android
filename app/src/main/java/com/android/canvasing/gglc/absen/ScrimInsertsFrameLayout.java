...
public class ScrimInsertsFrameLayout extends FrameLayout{
    ...
    public ScrimInsertsFrameLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public ScrimInsertsFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        mInsetForeground = a
                .getDrawable(R.styleable.ScrimInsetsView_insetForeground);
        a.recycle();
