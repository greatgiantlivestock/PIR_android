...
public class Log2File {
	...
	/**
	 * Init with default settings. Log file will be named "log_file.txt" and
	 * will be stored in directory named "Log2File" in root of SDCard.
	 */
	public static void init() {
		File dir = new File(AppVar.getFolderPath() + "/"
				+ AppVar.CONFIG_APP_FOLDER_CUSTOMER);
		if (!dir.exists())
			dir.mkdirs();
	...
	/**
	 * Init Log2File with log filename. Directory would be default one
	 * "Log2File"
	 * 
	 * @param fileName
	 *            file name
	 ...
	 * @param file
	 */
	private static void writeStringToAFile(String tag, final String data,
										   File file) {
