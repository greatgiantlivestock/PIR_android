...
public class Kompetitor extends FragmentActivity {
	private Context act;
	private ProgressDialog progressDialog;
	private Handler handler = new Handler();
	private String message;
	private String response_data;
	private static final String LOG_TAG = Kompetitor.class
			.getSimpleName();
	...
	private String IMAGE_DIRECTORY_NAME = "Kompetitor";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_kompetitor);
		...
		final String main_app_foto_1 = spPreferences.getString(
				AppVar.SHARED_PREFERENCES_KOMPETITOR_FOTO_1, null);
	...
	public class UploadData extends AsyncTask<String, Integer, String> {
		...
		protected String doInBackground(String... params) {
			...
			String uploadSupplier = AppVar.CONFIG_APP_URL_UPLOAD_INSERT_KOMPETITOR;
 ...
 */
	...
	public void saveAppSupplierFoto1(String responsedata) {
		...
		editor.putString(AppVar.SHARED_PREFERENCES_KOMPETITOR_FOTO_1,
				responsedata);
		editor.commit();
	}
