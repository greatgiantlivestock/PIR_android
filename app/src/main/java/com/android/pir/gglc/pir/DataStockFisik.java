...
public class DataStockFisik extends FragmentActivity {
	private Context act;
	private ProgressDialog progressDialog;
	private Handler handler = new Handler();
	private String message;
	private String response_data;
	private static final String LOG_TAG = DataStockFisik.class
			.getSimpleName();
...
//	private ListViewAdapter cAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_data_stock_fisik);
...
//			NetworkInfo mWifi = connManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI);
			...
			String url_add_req_load = AppVar.CONFIG_APP_URL_PUBLIC
				+ AppVar.CONFIG_APP_URL_UPLOAD_STOCK_FISIK;
...
//						.getResources()
//						.getString(
//								R.string.app_reqload_processing_upload_failed);
//				handler.post(new Runnable() {
//					public void run() {
//						showCustomDialog(msg);
//					}
			...
			if (response_data.isEmpty()) {
				...
				if (status.equalsIgnoreCase("True")) {
					...
					final String msg = act
							...
							.getResources()
							.getString(
									R.string.app_stock_fisik_upload_success);
...
//					}
	...
	private void updateListViewDetailOrder(DetailReqLoad detailReqLoad) {
		...
		cAdapter = new ListViewAdapter(DataStockFisik.this,
