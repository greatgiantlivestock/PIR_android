...
public class CheckinOneFragmentActivity1 extends FragmentActivity {
    Context thiscontext;
...
//    private String IMAGE_DIRECTORY_NAME = "Kanvas";
    ...
    private static final String LOG_TAG = CheckinOneFragmentActivity1.class.getSimpleName();
    ...
    public CheckinOneFragmentActivity1() {
        //no coding in here
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.checkinfragment_oneactivity);

        act=this;
        databaseHandler = new DatabaseHandler(this);
        spinnerRencanaDetail = (Spinner) findViewById(R.id.id_rencna_detail);
        spinnerRencanaMaster = (Spinner) findViewById(R.id.nomor_rencana_value);
        spinnerCustomer = (Spinner) findViewById(R.id.id_customer);
        tvFotoCustomer = (TextView) findViewById(R.id.title_foto_customer);
        foto = (Button) findViewById(R.id.foto);
        checkin = (Button) findViewById(R.id.checkin);
        kanvassing = (Button) findViewById(R.id.kanvassing);
        imgCust = (ImageView) findViewById(R.id.ImgCust);
        no_checkin1 = (EditText) findViewById(R.id.no_checkin);
        ...
        if(databaseHandler.getCountDetailrencana()!=0){
            ...
            ArrayAdapter<String> adapterRencanaDetail = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, rencanaDetailStringList);
            ...
            ArrayAdapter<String> adapterCustomer = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, customerStringList);
...
//          super.onPreExecute();
//            loading1 = ProgressDialog.show(CheckinOneFragmentActivity1.this,"Mengunggah gambar...","Silahkan Tunggu...",false,false);
//            Log.d(LOG_TAG, "ok1");
//        }
//
//        @Override
                            ...
                            if (tvFotoCustomer.getText().length()!=0) {
                                ...
                                if(already_checkin==1){
                                    ...
                                    class insertToDatabase extends AsyncTask<Void, Void, String> {
                                        ...
                                        protected void onPreExecute() {
                                            super.onPreExecute();
                                            loading = ProgressDialog.show(CheckinOneFragmentActivity1.this,"Proses...","Silahkan Tunggu...",false,false);
                                        }
                                        ...
                                        protected void onPostExecute(String s) {
                                            ...
                                            loading.dismiss();
                                            Toast.makeText(CheckinOneFragmentActivity1.this,"Checkin Berhasil !",Toast.LENGTH_LONG).show();
                                            //resetCheckin();
...
//                                        resetCheckin();
                ...
                gotoDetailJadwal();
                Toast.makeText(this, "Silahkan periksa lokasi anda dahulu",Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if (requestCode == CAMERA_CAPTURE_IMAGE_REQUEST_CODE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Toast.makeText(getApplicationContext(),"Batal mengambil foto terbaru!", Toast.LENGTH_SHORT).show();
            } else {
