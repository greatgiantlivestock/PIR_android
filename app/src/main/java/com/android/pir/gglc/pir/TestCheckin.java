...
public class TestCheckin extends FragmentActivity {
	private Context act;
	private ProgressDialog progressDialog;
	private Handler handler = new Handler();
	private String response_data, newImageName, keterangan,id_user;
	private static final String LOG_TAG = TestCheckin.class.getSimpleName();
	private ImageView menuBackButton,imageView1;
	private Button btnUpload, refresh, btnFoto1;
	private double latitude,longitude;
	private Location location;
	private Uri fileUri;
	private final int MEDIA_TYPE_IMAGE = 1;
	private final int CAMERA_CAPTURE_IMAGE_REQUEST_CODE = 100;
	private String IMAGE_DIRECTORY_NAME = "Chiller";
	private String id_Image = "";
	private EditText edtSupplierKeterangan;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_chiller);
		...
		final String main_app_foto_1 = spPreferences.getString(
				AppVar.SHARED_PREFERENCES_CHILLER_FOTO_1, null);
	...
	public class UploadData extends AsyncTask<String, Integer, String> {
		...
		protected String doInBackground(String... params) {
			...
			String uploadSupplier = AppVar.CONFIG_APP_URL_UPLOAD_INSERT_CHILLER;
